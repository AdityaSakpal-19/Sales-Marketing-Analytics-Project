...
/****** Object:  Database [smdb]    Script Date: 11-01-2026 00:03:17 ******/
CREATE DATABASE [smdb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'smdb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL17.SQLEXPRESS\MSSQL\DATA\smdb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'smdb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL17.SQLEXPRESS\MSSQL\DATA\smdb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [smdb] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [smdb] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [smdb] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [smdb] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [smdb] SET OPTIMIZED_LOCKING = OFF 
GO

ALTER DATABASE [smdb] SET QUERY_STORE = ON
GO

ALTER DATABASE [smdb] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
